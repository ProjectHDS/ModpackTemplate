...
zh_cn_path = ".minecraft/resources/templateModpack/lang/zh_cn.lang"
en_us_path = ".minecraft/resources/templateModpack/lang/en_us.lang"
...
def replace_with_lang_key(line, key, f_list, index, file_name):
    ...
    lang_key = "templateModpack.quests.%s.%s" % (file_name, key)
